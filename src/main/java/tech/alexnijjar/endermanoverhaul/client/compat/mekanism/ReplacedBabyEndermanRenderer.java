...
public class ReplacedBabyEndermanRenderer extends GeoReplacedEntityRenderer<EntityBabyEnderman, ReplacedBabyEnderman> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, ReplacedBabyEnderman animatable, BakedGeoModel model, @Nullable RenderType renderType, MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, ReplacedBabyEnderman animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
